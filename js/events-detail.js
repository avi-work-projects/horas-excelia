...
function openEvDeleteSheet(ev){
  ...
  h+='<button class="action-edit action-edit-text ev-btn" id="evDelEdit">&#9998; Editar</button>';
...
function renderEvDetail(ev,fromSummary,car){
  ...
  if(ev._rut){
    ...
    h+='<button class="action-edit action-edit-text ev-btn ev-edit-orange" id="evDEdit">&#9998; Editar evento</button>';
