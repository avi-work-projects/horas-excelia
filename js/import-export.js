...
var _g4=document.getElementById('exportAllBtn'); if(_g4)_g4.addEventListener('click',function(){
  ...
  var data={version:7,calendarAuthor:evIcsAuthor(),calendarExports:evIcsRecords(),csvExports:csvExportRecords(),bodaConfig:JSON.parse(JSON.stringify(BODA_CONFIG)),mailConfig:_lsJson(MAIL_CFG_SK,null),days:ST,sent:SW,monthH:MONTH_H,rate:DAILY_RATE,
